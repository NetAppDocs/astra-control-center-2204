...
* https://docs.netapp.com/us-en/astra-control-center-2204/concepts/validated-vs-standard.html#validated-apps[Learn the difference between a validated app and a standard app in Astra Control^].
